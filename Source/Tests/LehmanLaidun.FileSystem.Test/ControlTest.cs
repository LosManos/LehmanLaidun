...
namespace LehmanLaidun.FileSystem.Test
{
    ...
    public partial class ControlTest
    {
        ...
        public void CanReturnFileInRoot()
        {
            ...
            var sut = LogicFactory.CreateForPath(mockedFileSystem, Root, null/*, pluginHandler*/);
  ...
  <directory name=''>
    <file name='whatever.jpg'/>
        ...
        public void CanReturnFileInTopMostFolder()
        {
            ...
            var sut = LogicFactory.CreateForPath(mockedFileSystem, Path, null/*, pluginHandler*/);
